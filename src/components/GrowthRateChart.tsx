...
export default function GrowthRateChart({
  ...
  return (
    <div className="relative h-80 w-full">
      {/* 颜色图例说明 - 右上角 */}
      <div className="absolute top-2 right-2 z-10 rounded-lg border border-slate-200 bg-white/90 p-2 backdrop-blur-sm">
        <div className="grid grid-cols-2 gap-1 text-xs text-slate-600">
          ...
          <div className="flex items-center gap-1">
            <div className="h-2 w-2 rounded-sm bg-amber-900"></div>
            <span>&lt;-25%</span>
          </div>
        </div>
      </div>
