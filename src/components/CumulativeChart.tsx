...
export default function CumulativeChart({ todayData, yesterdayData }: CumulativeChartProps) {
  // 获取当前时间
    ...
    <div className="w-full">
      ...
      <div className="mb-4 grid grid-cols-3 gap-4 text-xs text-slate-600">
        ...
        <div className="text-center">
          ...
          <div className={predictedTodayTotal > yesterdayFinalTotal ? 'text-green-600' : 'text-red-600'}>
        ...
        <div className="text-center">
          ...
          <div className={predictedTodayTotal > yesterdayFinalTotal ? 'text-green-600' : 'text-red-600'}>
            {predictedTodayTotal > yesterdayFinalTotal ? '+' : ''}{((predictedTodayTotal - yesterdayFinalTotal) / yesterdayFinalTotal * 100).toFixed(1)}%
          </div>
        </div>
      </div>
      ...
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          <defs>
            <linearGradient id="todayCumulativeGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#3b82f6" stopOpacity={0.6}/>
              <stop offset="95%" stopColor="#3b82f6" stopOpacity={0.1}/>
            </linearGradient>
            <linearGradient id="yesterdayCumulativeGradient" x1="0" y1="0" x2="0" y2="1">
